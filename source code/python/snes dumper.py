                ...
                while leyendo:
                    ...
                    if linea.strip(b'\x00'):  # Ignorar bytes vacíos
                        ...
                        if texto == cierre and escribiendo:
                            ...
                            convertir_texto_a_binario_memoria('.\\'+nombre+'_srm.txt', '.\\'+nombre+'.srm')
                ...
                while leyendo:
                    ...
                    if linea.strip(b'\x00'):  # Ignorar bytes vacíos
                        ...
                        if texto == cierre and escribiendo:
                            ...
                            ser.close()
                            # Llama a la función con los nombres de los archivos
                            convertir_texto_a_binario_memoria('.\\'+nombre+'.txt', '.\\'+nombre+'.sfc')
                            ############paro animación de carga
...
ventana.title("SNES DUMP ROM v.0.1.2")
